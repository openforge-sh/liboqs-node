...
async function loadModule() {
  ...
  const modulePath = isDeno
    ? `https://cdn.openforge.sh/${VERSION}/ntru-hrss-1373.deno.js`
    : `https://cdn.openforge.sh/${VERSION}/ntru-hrss-1373.min.js`;
 ...
 * @constant {Object} NTRU_HRSS_1373_INFO
 ...
 * @property {number} keySize.publicKey - Public key size (2401 bytes)
 * @property {number} keySize.secretKey - Secret key size (2983 bytes)
 * @property {number} keySize.ciphertext - Ciphertext size (2401 bytes)
