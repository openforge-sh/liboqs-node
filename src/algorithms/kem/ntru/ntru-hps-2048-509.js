...
import moduleFactory from '../../../../dist/ntru-hps-2048-509.min.js';
import { isUint8Array } from '../../../core/validation.js';

/**
 * Algorithm metadata for NTRU-HPS-2048-509
 * @constant {Object} NTRU_HPS_2048_509_INFO
 ...
 * @property {number} keySize.publicKey - Public key size (699 bytes)
 * @property {number} keySize.secretKey - Secret key size (935 bytes)
 * @property {number} keySize.ciphertext - Ciphertext size (699 bytes)
 ...
 *
 * @example
 * import { createNTRUHps2048509 } from '@openforge-sh/liboqs-node';
 *
