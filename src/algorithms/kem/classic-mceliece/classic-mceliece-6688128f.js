...
async function loadModule() {
  ...
  const modulePath = isDeno
    ? `https://cdn.openforge.sh/${VERSION}/classic-mceliece-6688128f.deno.js`
    : `https://cdn.openforge.sh/${VERSION}/classic-mceliece-6688128f.min.js`;
 ...
 * @example
 * import { createClassicMcEliece6688128f } from '@openforge-sh/liboqs';
