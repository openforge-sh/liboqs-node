...
async function loadModule() {
  ...
  const modulePath = isDeno
    ? `https://cdn.openforge.sh/${VERSION}/snova-24-5-4-esk.deno.js`
    : `https://cdn.openforge.sh/${VERSION}/snova-24-5-4-esk.min.js`;
...
/**
 * Algorithm metadata for SNOVA-24-5-4-esk
 * @constant {Object} SNOVA_24_5_4_ESK_INFO
