...
import moduleFactory from '../../../../dist/snova-25-8-3.min.js';
 ...
 *
 * @example
 * import { createSnova2583 } from '@openforge-sh/liboqs-node';
 *
...
export class Snova2583 {
   ...
   * @returns {Promise<Uint8Array>} Digital signature (up to 165 bytes)
   * @throws {LibOQSError} If instance is destroyed
