...
import moduleFactory from '../../../../dist/snova-56-25-2.min.js';
import { isUint8Array } from '../../../core/validation.js';

/**
 * Algorithm metadata for SNOVA-56-25-2
 * @constant {Object} SNOVA_56_25_2_INFO
 ...
 * @property {number} keySize.publicKey - Public key size (31266 bytes)
 * @property {number} keySize.secretKey - Secret key size (48 bytes)
 * @property {number} keySize.signature - Maximum signature size (178 bytes)
 */
 ...
 *
 * @example
 * import { createSnova56252 } from '@openforge-sh/liboqs-node';
 *
...
export class Snova56252 {
   ...
   * @returns {Promise<Uint8Array>} Digital signature (up to 178 bytes)
   * @throws {LibOQSError} If instance is destroyed
