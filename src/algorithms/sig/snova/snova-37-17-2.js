...
import moduleFactory from '../../../../dist/snova-37-17-2.min.js';
 ...
 *
 * @example
 * import { createSnova37172 } from '@openforge-sh/liboqs-node';
 *
...
export class Snova37172 {
   ...
   * @returns {Promise<Uint8Array>} Digital signature (up to 124 bytes)
   * @throws {LibOQSError} If instance is destroyed
