...
import moduleFactory from '../../../../dist/ov-v-pkc.min.js';
import { isUint8Array } from '../../../core/validation.js';

/**
 * Algorithm metadata for OV-V-pkc
 * @constant {Object} OV_V_PKC_INFO
 ...
 * @property {number} keySize.publicKey - Public key size (446992 bytes)
 * @property {number} keySize.secretKey - Secret key size (2436704 bytes)
 * @property {number} keySize.signature - Maximum signature size (260 bytes)
 */
 ...
 *
 * @example
 * import { createOVVPkc } from '@openforge-sh/liboqs-node';
 *
...
export class OVVPkc {
   ...
   * @returns {Promise<Uint8Array>} Digital signature (up to 260 bytes)
   * @throws {LibOQSError} If instance is destroyed
