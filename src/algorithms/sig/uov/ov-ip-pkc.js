...
async function loadModule() {
  ...
  const modulePath = isDeno
    ? `https://cdn.openforge.sh/${VERSION}/ov-ip-pkc.deno.js`
    : `https://cdn.openforge.sh/${VERSION}/ov-ip-pkc.min.js`;
...
/**
 * Algorithm metadata for OV-Ip-pkc
 * @constant {Object} OV_IP_PKC_INFO
 ...
 *
 * @example
 * import { createOVIpPkc } from '@openforge-sh/liboqs';
 *
