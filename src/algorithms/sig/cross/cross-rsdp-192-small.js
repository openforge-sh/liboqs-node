...
import moduleFactory from '../../../../dist/cross-rsdp-192-small.min.js';
import { isUint8Array } from '../../../core/validation.js';

/**
 * Algorithm metadata for CROSS-rsdp-192-small
 * @constant {Object} CROSS_RSDP_192_SMALL_INFO
 ...
 * @property {number} keySize.signature - Maximum signature size (28391 bytes)
 */
 ...
 *
 * @example
 * import { createCrossRsdp192Small } from '@openforge-sh/liboqs-node';
 *
...
export class CrossRsdp192Small {
   ...
   * @returns {Promise<Uint8Array>} Signature (variable length, max 28391 bytes)
   * @throws {LibOQSError} If instance is destroyed
