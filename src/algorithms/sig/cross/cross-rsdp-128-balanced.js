...
import moduleFactory from '../../../../dist/cross-rsdp-128-balanced.min.js';
import { isUint8Array } from '../../../core/validation.js';

/**
 * Algorithm metadata for CROSS-rsdp-128-balanced
 * @constant {Object} CROSS_RSDP_128_BALANCED_INFO
 ...
 * @property {number} keySize.publicKey - Public key size (77 bytes)
 * @property {number} keySize.secretKey - Secret key size (32 bytes)
 * @property {number} keySize.signature - Maximum signature size (13152 bytes)
 */
 ...
 *
 * @example
 * import { createCrossRsdp128Balanced } from '@openforge-sh/liboqs-node';
 *
...
export class CrossRsdp128Balanced {
   ...
   * @returns {Promise<Uint8Array>} Signature (variable length, max 13152 bytes)
   * @throws {LibOQSError} If instance is destroyed
