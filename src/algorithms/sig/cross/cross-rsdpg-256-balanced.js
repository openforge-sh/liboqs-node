...
import moduleFactory from '../../../../dist/cross-rsdpg-256-balanced.min.js';
import { isUint8Array } from '../../../core/validation.js';

/**
 * Algorithm metadata for CROSS-rsdpg-256-balanced
 * @constant {Object} CROSS_RSDPG_256_BALANCED_INFO
 ...
 * @property {number} keySize.signature - Maximum signature size (40100 bytes)
 */
 ...
 *
 * @example
 * import { createCrossRsdpg256Balanced } from '@openforge-sh/liboqs-node';
 *
...
export class CrossRsdpg256Balanced {
   ...
   * @returns {Promise<Uint8Array>} Signature (variable length, max 40100 bytes)
   * @throws {LibOQSError} If instance is destroyed
