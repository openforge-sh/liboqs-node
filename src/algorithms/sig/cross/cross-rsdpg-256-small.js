...
import moduleFactory from '../../../../dist/cross-rsdpg-256-small.min.js';
 ...
 *
 * @example
 * import { createCrossRsdpg256Small } from '@openforge-sh/liboqs-node';
 *
...
export class CrossRsdpg256Small {
   ...
   * @returns {Promise<Uint8Array>} Signature (variable length, max 36454 bytes)
   * @throws {LibOQSError} If instance is destroyed
