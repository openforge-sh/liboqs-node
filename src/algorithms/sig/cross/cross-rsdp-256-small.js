...
import moduleFactory from '../../../../dist/cross-rsdp-256-small.min.js';
 ...
 *
 * @example
 * import { createCrossRsdp256Small } from '@openforge-sh/liboqs-node';
 *
...
export class CrossRsdp256Small {
   ...
   * @returns {Promise<Uint8Array>} Signature (variable length, max 50818 bytes)
   * @throws {LibOQSError} If instance is destroyed
