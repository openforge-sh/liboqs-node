 ...
 * @constant {Object} CROSS_RSDP_256_BALANCED_INFO
 ...
 * @property {number} keySize.signature - Maximum signature size (53527 bytes)
 */
 ...
 *
 * @example
 * import { createCrossRsdp256Balanced } from '@openforge-sh/liboqs-node';
 *
...
export class CrossRsdp256Balanced {
   ...
   * @returns {Promise<Uint8Array>} Signature (variable length, max 53527 bytes)
   * @throws {LibOQSError} If instance is destroyed
