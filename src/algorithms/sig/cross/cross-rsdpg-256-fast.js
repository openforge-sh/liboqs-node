...
import moduleFactory from '../../../../dist/cross-rsdpg-256-fast.min.js';
 ...
 *
 * @example
 * import { createCrossRsdpg256Fast } from '@openforge-sh/liboqs-node';
 *
...
export class CrossRsdpg256Fast {
   ...
   * @returns {Promise<Uint8Array>} Signature (variable length, max 48102 bytes)
   * @throws {LibOQSError} If instance is destroyed
