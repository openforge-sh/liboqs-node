...
import moduleFactory from '../../../../dist/cross-rsdpg-128-fast.min.js';
 ...
 *
 * @example
 * import { createCrossRsdpg128Fast } from '@openforge-sh/liboqs-node';
 *
...
export class CrossRsdpg128Fast {
   ...
   * @returns {Promise<Uint8Array>} Signature (variable length, max 12672 bytes)
   * @throws {LibOQSError} If instance is destroyed
