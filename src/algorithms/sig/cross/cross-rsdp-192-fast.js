...
import moduleFactory from '../../../../dist/cross-rsdp-192-fast.min.js';
import { isUint8Array } from '../../../core/validation.js';

/**
 * Algorithm metadata for CROSS-rsdp-192-fast
 * @constant {Object} CROSS_RSDP_192_FAST_INFO
 ...
 * @property {number} keySize.signature - Maximum signature size (41406 bytes)
 */
 ...
 *
 * @example
 * import { createCrossRsdp192Fast } from '@openforge-sh/liboqs-node';
 *
...
export class CrossRsdp192Fast {
   ...
   * @returns {Promise<Uint8Array>} Signature (variable length, max 41406 bytes)
   * @throws {LibOQSError} If instance is destroyed
