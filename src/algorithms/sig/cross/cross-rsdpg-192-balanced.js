...
import moduleFactory from '../../../../dist/cross-rsdpg-192-balanced.min.js';
 ...
 *
 * @example
 * import { createCrossRsdpg192Balanced } from '@openforge-sh/liboqs-node';
 *
...
export class CrossRsdpg192Balanced {
   ...
   * @returns {Promise<Uint8Array>} Signature (variable length, max 22464 bytes)
   * @throws {LibOQSError} If instance is destroyed
