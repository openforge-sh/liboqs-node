...
import moduleFactory from '../../../../dist/cross-rsdp-128-small.min.js';
import { isUint8Array } from '../../../core/validation.js';

/**
 * Algorithm metadata for CROSS-rsdp-128-small
 * @constant {Object} CROSS_RSDP_128_SMALL_INFO
 ...
 * @property {number} keySize.signature - Maximum signature size (12432 bytes)
 */
 ...
 *
 * @example
 * import { createCrossRsdp128Small } from '@openforge-sh/liboqs-node';
 *
...
export class CrossRsdp128Small {
   ...
   * @returns {Promise<Uint8Array>} Signature (variable length, max 12432 bytes)
   * @throws {LibOQSError} If instance is destroyed
