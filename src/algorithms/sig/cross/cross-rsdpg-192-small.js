...
import moduleFactory from '../../../../dist/cross-rsdpg-192-small.min.js';
import { isUint8Array } from '../../../core/validation.js';

/**
 * Algorithm metadata for CROSS-rsdpg-192-small
 * @constant {Object} CROSS_RSDPG_192_SMALL_INFO
 ...
 * @property {number} keySize.signature - Maximum signature size (20452 bytes)
 */
 ...
 *
 * @example
 * import { createCrossRsdpg192Small } from '@openforge-sh/liboqs-node';
 *
...
export class CrossRsdpg192Small {
   ...
   * @returns {Promise<Uint8Array>} Signature (variable length, max 20452 bytes)
   * @throws {LibOQSError} If instance is destroyed
