...
import moduleFactory from '../../../../dist/cross-rsdpg-192-fast.min.js';
import { isUint8Array } from '../../../core/validation.js';

/**
 * Algorithm metadata for CROSS-rsdpg-192-fast
 * @constant {Object} CROSS_RSDPG_192_FAST_INFO
 ...
 * @property {number} keySize.signature - Maximum signature size (26772 bytes)
 */
...
export class CrossRsdpg192Fast {
   ...
   * @returns {Promise<Uint8Array>} Signature (variable length, max 26772 bytes)
   * @throws {LibOQSError} If instance is destroyed
