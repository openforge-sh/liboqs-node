 ...
 * @constant {Object} CROSS_RSDP_128_FAST_INFO
 ...
 * @property {number} keySize.signature - Maximum signature size (18432 bytes)
 */
 ...
 *
 * @example
 * import { createCrossRsdp128Fast } from '@openforge-sh/liboqs-node';
 *
...
export class CrossRsdp128Fast {
   ...
   * @returns {Promise<Uint8Array>} Signature (variable length, max 18432 bytes)
   * @throws {LibOQSError} If instance is destroyed
